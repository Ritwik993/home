...
const BenefitSection=()=>{
    return(
        <div className="flex flex-col items-center text-center justify-center mt-[100px] ">
            <h1 className="font-bold md:text-[36px] text-[28px] md:text-center text-left text-[#2F327D] md:w-[860px] w-[100vw] md:pl-0 pl-[20px]">3 key differences that make BrandNav the world’s ultimate eCommerce leads database</h1>
            <Card/>
            <Card2/>
            <Card3/>
            <button className="text-white text-medium text-[16px] bg-[#0084FF] p-[10px] w-[175px] rounded-[5px] ml-[8px] shadow-xl mt-[30px]">Grab free leads</button>
