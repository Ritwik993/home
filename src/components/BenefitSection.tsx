...
const BenefitSection=()=>{
    return(
        <div className="flex flex-col items-center text-center justify-center mt-[100px] ">
            <h1 className="font-bold md:text-[36px] text-[28px] md:text-center text-left text-[#2F327D] md:w-[860px]  md:pl-0 pl-[20px]">3 key differences that make BrandNav the world’s ultimate eCommerce leads database</h1>
            <Card/>
            <Card2/>
            <Card3/>
