...
const Banner=()=>{
    return(
        <div className="mt-[100px] bg-gradient-to-r from-[#240036] to-[#003252] md:px-[50px] px-[30px] py-[50px] rounded-[8px] flex flex-col  items-center justify-center text-center md:w-auto w-[90vw]">
            ...
            <div>
            <input type="text" placeholder="Enter your email" className=" py-[10px] px-[20px] bg-white md:w-[370px] w-[80vw] outline-none border border-[#9CB4EB] rounded-[8px] shadow-md mb-[20px] md:mb-0 mt-[40px]"/>
