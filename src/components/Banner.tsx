...
const Banner=()=>{
    return(
        <div className="mt-[100px] bg-gradient-to-r from-[#240036] to-[#003252] md:px-[50px] px-[30px] py-[30px] rounded-[8px] flex flex-col  items-center justify-center text-center">
            ...
            <div>
            <input type="text" placeholder="Enter your email" className=" py-[10px] px-[20px] bg-white w-[370px] outline-none border border-[#9CB4EB] rounded-[8px] shadow-md mb-[20px] md:mb-0 mt-[30px]"/>
            <button className="text-white text-medium text-[20px] bg-[#0084FF] p-[10px] md:w-[216px] rounded-[8px] md:ml-[8px] shadow-md w-full">Grab free leads</button>
            </div>
