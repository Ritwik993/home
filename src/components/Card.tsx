...
const Card=()=>{
    return(
        <div className="flex md:flex-row flex-col justify-between gap-[80px] bg-[#EDFAFE] shadow-xl  rounded-[13px] pl-[30px] pt-[100px] md:pr-[100px] pr-[40px] pb-[20px] md:mt-[60px] mt-[20px] ml-[20px] mr-[20px] md:ml-0 md:mr-0">
