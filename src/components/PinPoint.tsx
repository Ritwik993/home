...
const PinPoint=()=>{
    return(
      <div className="flex flex-col items-center justify-center w-[100vw]">
        ...
        <div className="hidden md:flex justify-between items-center px-[200px] w-[100vw] ">
        ...
        <div className="hidden md:flex justify-between w-[100vw] items-center px-[350px] mt-[20px]">
          <div className="flex flex-col items-center ">
