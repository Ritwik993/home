...
const HeroSection=()=>{
    return(
        <div className="flex flex-col items-center justify-center text-center mb-[60px]">
            ...
            <input type="text" placeholder="Enter your email" className=" py-[10px] px-[20px] bg-white md:w-[370px] w-full outline-none border border-[#9CB4EB] rounded-[8px] shadow-md mb-[20px] md:mb-0"/>
