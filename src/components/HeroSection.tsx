...
const HeroSection=()=>{
    return(
        <div className="flex flex-col items-center justify-center text-center mb-[60px]">
            ...
            <div className="relative md:mb-[40px] mb:[35px]">
            ...
            <div>
            <p className="text-[#595B97] md:text-[18px] text-[16px] font-regular md:mb-[50px] mb-[35px]" >Discover untapped eCommerce brands with our high-quality unsaturated leads database</p>
