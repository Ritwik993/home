...
const Card2=()=>{
    return(
        <div className="flex md:flex-row flex-col justify-between md:items-center gap-[80px] pt-[40px] pb-[40px] bg-[#EDFAFE] shadow-xl  rounded-[13px] pl-[30px] md:pt-[80px] md:pr-[100px] pr-[40px] md:pb-[80px] md:mt-[60px] mt-[20px] ml-[20px] mr-[20px] md:ml-0 md:mr-0 md:w-auto w-[90vw]">
